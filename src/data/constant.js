const emailDetails = require("./variable");

const emailBody = {
  subject: `Enthusiastic Developer Eager to Elevate ${emailDetails.companyName}`,
  body: `
<p>Hey ${emailDetails.firstName},</p>
<p>I hope you are doing well. I recently discovered ${emailDetails.companyName}, and I'm impressed by ${emailDetails.uniqueFeature}.</p>
...
<p>I noticed that ${emailDetails.companyName} is hiring for the Backend Development role. I am excited about the opportunity to contribute at ${emailDetails.companyName}. I believe my skills and experiences align seamlessly with the company's goals.</p>
